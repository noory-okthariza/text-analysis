...
We fit the model by setting the K-parameter. In this case, it is set to 5. Don't forget to always fine-tune the parameter according to your document to make a more meaningful interpretation.
